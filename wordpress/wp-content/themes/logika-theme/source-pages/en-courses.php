...
<body>
  @include('partials/header.html')
   ...
   <main>
    <section class="banner-section en-courses">
          ...
          <div class="banner-section__blocks">
            <div class="banner-section__left">
              <div class="banner-section__info">
                <h1 class="banner-section__title">Школа англійської мови для дітей 7-17 років</h1>
              ...
              <div class="banner-section__character-boy">
                ...
                <div class="banner-section__decor">
                  <img src="img/en-courses/en-courses-drawing.svg" alt="">
                </div>
              </div>
            </div>
            ...
            <div class="banner-section__right">
              ...
              <div class="banner-section__character-logika">
                <img width='97' height='146' src='img/en-courses/en-courses-icon.svg' alt='boy-character'>
              </div>
            </div>
          </div>
          ...
          <div class="test-section__left">
            <div class="test-section__content">
              <div class="test-section__box">
                ...
                <p class="test-section__text h5">Допоможемо визначити рівень підготовки, інтереси та формат навчання, щоб дитині було комфортно й цікаво навчатися з перших занять.</p>
              </div>
