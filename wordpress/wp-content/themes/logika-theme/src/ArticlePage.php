...
final class Logika_Theme_Article_Page {
	...
	private static function socials( int $post_id ): array {
		$networks = array( 'instagram' => array( 'label' => 'Instagram', 'icon' => 'Instagram-filled', 'url' => 'https://www.instagram.com/logika_it_school/' ), 'facebook' => array( 'label' => 'Facebook', 'icon' => 'Facebook-filed', 'url' => 'https://www.facebook.com/logika.it.school/' ), 'youtube' => array( 'label' => 'YouTube', 'icon' => 'Youtube-filled', 'url' => 'https://www.youtube.com/channel/UCFIBb_OZ1TPuhcjZUhVbifg' ) );
